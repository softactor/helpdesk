...
function getStatusDivById($id){
    if($id == 0){
        $name   =   '<span class="label label-warning">Pending</span>';
    }elseif($id == 1){
        $name   =   '<span class="label label-success">Solved</span>';
    }elseif($id == 2){
        $name   =   '<span class="label label-primary">Running</span>';
    }
    return $name;
}
